...
<body class="bd-w">
    ...
    <section class="content-edit">
        ...
        <div class="container" id="input-text-edit">
            <div class="rounded-lg" id="card-phone2">
                <div class="">
                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10">
                        <div class="input-text-edit"> 0858664232</div>
                    </div>
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                        <a href="" data-toggle="modal" data-target="#add-data-phone" id="icon-edit-data">
                            <div class="f-right">
    ...
    <div id="add-data-phone" class="modal fade" >
        <div class="modal-dialog modal-sm">
            <div class="modal-content w100" >
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-t20">Your Phone</h4>
                </div>
                <div class="modal-body" id="modal-body-pad"  >
                    <form method="post" id="create-data" >
                        <div class="form-group form-float">
                        <div class="form-line" id="class1">
                            <input type="Number" class="form-control t16" id="phone" />
                            <label class="form-label t16" id="label-edit">Ex : 086454234263</label>
                        </div>
                        </div>
                        ...
                        <div class="button-edit">
                            ...
                            <button class="button-text-blue" type="button" id="btn-create-data-phone"  > Done </button>
                        </div>
                        </div>
                    </form>
                </div>
...
<script type="text/javascript">
    $('#btn-create-data-phone').click(function(){
        var phone = $('#phone');
