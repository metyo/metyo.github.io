...
<body class="bd-w">
    ...
    <section class="content-edit">
        ...
        <div class="container" id="input-text-edit">
            <div class="rounded-lg" id="card-phone2">
                <div class="">
                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10">
                       <div class="input-text-edit"> Select Your Timezone</div>
                    </div>
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                        <a href="" data-toggle="modal" data-target="#add-data-timezone" id="icon-edit-data">
                            <div class="f-right">
    ...
    <div id="add-data-timezone" class="modal fade" >
        <div class="modal-dialog modal-sm">
            <div class="modal-content w100">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-t20">Timezone</h4>
                </div>
                <div class="modal-body" id="modal-body-pad"  >
                    <form method="post" id="create-data" >
                    <select class="form-control1 t16" id="timezone">
                        <option value="">-- Select Timezone --</option>
                        <option value="UTC−10:00 — French Polynesia"> UTC−10:00 — French Polynesia</option>
                        <option value="UTC−09:30 — Marquesas Islands">UTC−09:30 — Marquesas Islands</option>
                        <option value="UTC−09:00 — Gambier Islands">UTC−09:00 — Gambier Islands</option>
                    ...
                    <div class="modal-edit" >
                        <div class="button-edit">
                            ...
                            <button class="button-text-blue" type="button" id="btn-create-data-timezone"  > Done </button>
                        </div>
                    </div>
                    </form>
                </div>
...
<script type="text/javascript">
    $('#btn-create-data-timezone').click(function(){
