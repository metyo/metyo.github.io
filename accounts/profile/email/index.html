     ...
     <section class="content-edit">
        ...
        <div class="container" id="input-text-edit">
            <div class="rounded-lg" id="card-phone2">
                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10">
                    <div class="input-text-edit">ex : example@domain.com</div>
                </div>
                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                    <a  data-toggle="modal" data-target="#add-data-email" id="icon-edit-data">
                        <div class="f-right">
...
<script type="text/javascript">
    $('#btn-create-data-email').click(function(){
        var email = $('#email');
