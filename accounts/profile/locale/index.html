    ...
    <section class="content-edit">
        ...
        <div class="container" id="input-text-edit">
            <div class="rounded-lg" id="card-phone2">
                <div class="">
                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10">
                        <div class="input-text-edit"> English</div>
                    </div>
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                        <a href="" data-toggle="modal" data-target="#add-data-locale" id="icon-edit-data">
                            <div class="f-right">
                    ...
                    <form method="post" id="create-data" >
                        ...
                        <div class="modal-edit" >
                            <div class="button-edit">
                                ...
                                <button class="button-text-blue" type="button" id="btn-create-data-locale"  > Done </button>
                            </div>
                        </div>
                    </form>
                </div>
...
<script type="text/javascript">
    $('#btn-create-data-locale').click(function(){
        var locale = $('#locale');
        if( locale.val() == '' || locale.val() == null)
        {
            alert('Please select your locale!');
            return false;
        }
        else{
            $('#add-data-locale').modal('hide');
