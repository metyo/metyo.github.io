...
<body class="bd-w">
    ...
    <section class="content-edit">
        ...
        <div class="container" id="input-text-edit">
            <div class="rounded-lg" id="card-phone2">
                <div class="">
                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10">
                        <div class="input-text-edit"> Eko</div>
                    </div>
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                        <a href="" data-toggle="modal" data-target="#add-data-nickname" id="icon-edit-data">
                            <div class="f-right">
    ...
    <div id="add-data-nickname" class="modal fade" >
        <div class="modal-dialog modal-sm">
            <div class="modal-content w100" >
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-t20">Nick Name</h4>
                </div>
                <div class="modal-body" id="modal-body-pad"  >
                    <form method="post" id="create-data" >
                        <div class="form-group form-float">
                            <div class="form-line" id="class1">
                                <input type="text" class="form-control t16" id="nickname" />
                                <label class="form-label t16" id="label-edit" >Nick Name</label>
                            </div>
                        </div>
                        <div class="modal-edit" >
                            <div class="button-edit">
                                <button class="button-text-grey" type="button" id="btn-batal-create"  data-dismiss="modal"> Close </button> 
                                <button class="button-text-blue" type="button" id="btn-create-data-nickname"  > Done </button>
                            </div>
                        </div>
                    </form>
                </div>
...
<script type="text/javascript">
    $('#btn-create-data-nickname').click(function(){
