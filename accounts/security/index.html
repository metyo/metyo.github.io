                ...
                <ul class="list">
                    ...
                    <li class="active-menu-right">
                        <a href="../security" id="waves-effect-this">
                            <div class="icon-menu-img-left">
                                <img src="../images/icon svg/active/menu-security-icon.svg" width="20" height="20">
                            </div>
                            <span><font class="icon-menu-active">Security</font></span>
                        </a>
                    </li>
                    <li class="menu-waves-block">
                ...
                <div  >
                    <div class="card card20" >
                        <div class="link-2-profile" id="d-lk-top1" >  
                            <div class="">
                                <div class="text-grey5 link-content-home" > 
                                    <div class="line-H" >
                        ...
                        <a href="change-password" class="waves-effect waves-block" id="waves-block"> 
                            <div class="row link-1-profile" id="" >  
                                <div class="col-lg-10 col-md-10 col-sm-10">
                                    <div class="text-grey5 link-content-home w-in82" >Change Password
                                    </div>
                                </div>
                                <div class="col-lg-2 col-md-1 col-sm-2" id="item-link1">
                                    <div class="text-grey2 txt-ctr"> 
                                        <img src="../images/icon svg/next.svg" id="icon-right-link1-sec">
                                    </div>
                                </div>
                            </div>
                            <div class="bottom-content-link" ></div>
                        </a>
                        <a href="two-factor-authentication" class="waves-effect waves-block" id="waves-block" > 
                            <div class="row link-1-profile" id="" >  
                                <div class="col-lg-10 col-md-10 col-sm-10">
                                    <div class="text-grey5 link-content-home w-in82" >Two Factor Authentication
                                    </div>
                                </div>
                                <div class="col-lg-2 col-md-1 col-sm-2" id="item-link1">
                                    <div class="text-grey2 txt-ctr"> 
                        ...
                        <a href="security-question" class="waves-effect waves-block"  id="waves-block" > 
                            <div class="row link-1-profile" id="" >  
                                <div class="col-lg-10 col-md-10 col-sm-10">
                                    <div class="text-grey5 link-content-home w-in82" >Security Question 
                                    </div>
                                </div>
                                <div class="col-lg-2 col-md-1 col-sm-2" id="item-link1">
                                    <div class="text-grey2 txt-ctr"> 
                        ...
                        <a href="allowed-ip" class="waves-effect waves-block" id="waves-block"> 
                            <div class="row link-1-profile" id="" >  
                                <div class="col-lg-10 col-md-10 col-sm-10">
                                    <div class="text-grey5 link-content-home w-in82" >Allowed IP Address
                                    </div>
                                </div>
                                <div class="col-lg-2 col-md-1 col-sm-2" id="item-link1">
                                    <div class="text-grey2 txt-ctr"> 
                        ...
                        <a href="app-password" class="waves-effect waves-block" id="waves-block"> 
                            <div class="row link-1-profile" id="" >  
                                <div class="col-lg-10 col-md-10 col-sm-10">
                                    <div class="text-grey5 link-content-home w-in82" >APP Password
                                    </div>
                                </div>
