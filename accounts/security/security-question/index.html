...
<body class="bd-w">
    ...
    <section class="content-edit">
        ...
        <div class="container" id="card-link-profile">
            <div class="block-header title-name2" >
                ...
                <div class="pad10top">
                    <h2 class="line-H">Making questions will make it easier for you if you forget your password.</h2>
                </div>
            </div>
        </div>
        <div class="container" id="input-text-edit">
            <div class="rounded-lg" id="card-phone2">
                <div class="">
                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10">
                        <div class="input-text-edit"> Change Security Question</div>
                    </div>
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                        <a href="" data-toggle="modal" data-target="#add-data-modal-question" id="icon-edit-data">
                            <div class="f-right">
    ...
    <div id="add-data-modal-question" class="modal fade" >
        <div class="modal-dialog modal-sm">
            <div class="modal-content w100">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-t20">Security Question</h4>
                </div>
                <div class="modal-body" id="modal-body-pad"  >
                    <form method="post" id="create-data" >
                        <div class="form-group form-float">
                            <div class="form-line" id="class1question">
                                <input type="text" class="form-control t16" id="input1question" />
                                <label class="form-label t16" id="label-edit">Current Password</label>
                            </div>
                        </div>

                        <div class="form-group form-float">
                            <div class="form-line" id="class2question">
                                <input type="text" class="form-control t16" id="input2question" />
                                <label class="form-label" id="label-edit" >Security Question</label>
                            </div>
                        </div>

                        <div class="form-group form-float">
                            <div class="form-line" id="class3question">
                                <input type="text" class="form-control t16" id="input3question" />
                                <label class="form-label" id="label-edit" >Answer</label>
                            </div>
                        </div>

                        <div class="modal-edit" style="padding-top: 10px;" >
                            <div class="button-edit">
                                <button class="button-text-grey" type="button" id="btn-batal-create"  data-dismiss="modal"> Close </button> 
                                <button class="button-text-blue" type="button" id="btn-create-data-question"  > Done </button>
                            </div>
                        </div>
                    </form>
                </div>
...
<script type="text/javascript">
    $('#btn-create-data-question').click(function(){
        var input1question = $('#input1question');
        var input2question = $('#input2question');
        var input3question = $('#input3question');
        var class1question = $('#class1question');
        var class2question = $('#class2question');
        var class3question = $('#class3question');
        if( input1question.val() == '' || input1question.val() == null)
        {
            alert('Please complete the data !');
            return false;
        }
        else{
            if( input2question.val() == '' || input2question.val() == null)
            {
            alert('Please complete the data !');
            return false;
            }
            else{
                if( input3question.val() == '' || input3question.val() == null)
                {
                    alert('Please complete the data !');
                    return false;
                }
                else{
                    $('#add-data-modal-question').modal('hide');
                    input1question.val('');
                    input2question.val('');
                    input3question.val(''); 
                    class1question.removeClass('focused');
                    class2question.removeClass('focused');
                    class3question.removeClass('focused');
