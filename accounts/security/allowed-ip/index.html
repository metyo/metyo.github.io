        ...
        <div class="container" id="card-link-profile">
            <div class="block-header title-name2" >
                <a href="../" id="back-link-profile">
                    ...
                    <span>Allowed IP Address</span>
                </a> 
                <div class="pad10top">
                    <h2 class="line-H">Configure and manage trusted IP address/ranges to restrict your account acces through those IP address only.</h2>
                </div>
            </div>
        </div>
        <div class="container" id="input-text-edit">
            <div class="rounded-lg" id="card-phone2">
                 <div class="edit-profile-text" id="text-input-allowed">
                    Trusted IP address restrictions are not activated to acces your account. you can active this now by configuring the allowed IP addres/ranges through which your account access are trusted.
                    <br /><br />
                    <a href=""><button class="btn btn-success padtop5" >ADD NEW</button></a>
                </div>
            </div>
        </div>
        <br />
