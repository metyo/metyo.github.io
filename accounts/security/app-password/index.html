...
<body class="bd-w">
    ...
    <section class="content-edit">
        ...
        <div class="container" id="card-link-profile">
            <div class="block-header title-name2" >
                ...
                <div class="pad10top">
                    <h2 class="line-H">Create password for Your APP.</h2>
                </div>
            </div>
        </div>
        <div class="container" id="input-text-edit">
            <div class="rounded-lg" id="card-phone2">
                <div class="">
                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10">
                        <div class="input-text-edit">Change APP Password</div>
                    </div>
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                        <a href="" data-toggle="modal" data-target="#add-data-modal-app-password" id="icon-edit-data">
                            <div class="f-right">
    ...
    <div id="add-data-modal-app-password" class="modal fade" >
        <div class="modal-dialog modal-sm">
            <div class="modal-content w100" >
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-t20">APP Password</h4>
                </div>
                <div class="modal-body" id="modal-body-pad"  >
                    <form method="post" id="create-data" >
                        <div class="form-group form-float">
                            <div class="form-line" id="classapppassword">
                                <input type="password" class="form-control t16" id="inputapppassword" />
                                <label class="form-label t16" id="label-edit">APP Password</label>
                            </div>
                        </div>
                        ...
                        <div class="modal-edit" >
                            <div class="button-edit">
                                ...
                                <button class="button-text-blue" type="button" id="btn-create-data-app-password"  > Done </button>
                            </div>
                        </div>
                    </form>
                </div>
...
<script type="text/javascript">
    $('#btn-create-data-app-password').click(function(){
            var inputapppassword = $('#inputapppassword');
            var classapppassword = $('#classapppassword');
            var numbers = /[0-9]/g;    
            if( inputapppassword.val() == '' || inputapppassword.val() == null)
            {
                alert('Please complete the data !');
                return false;   
            }
            else{
                if( inputapppassword.val().length < 8 )
                {
                    alert('Your password is not long enough !');
                    return false;   
                }
                else{
                    if( inputapppassword.val().match(numbers) )
                    {
                        $('#add-data-modal-app-password').modal('hide');
                        inputapppassword.val('');
                        classapppassword.removeClass('focused');
                        $('#input-alert-edit-success').attr('style','display:block');
                        $('#input-alert-edit-error').attr('style','display:block');
                    }
                    else{ 
                        alert('Passwords must collaborate with numbers !');
                        return false;   
                    }
                }
            }
