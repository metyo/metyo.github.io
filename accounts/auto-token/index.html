                ...
                <ul class="list">
                    ...
                    <li class="active-menu-right">
                        <a href="../auto-token" id="waves-effect-this">
                            <div class="icon-menu-img-left">
                                <img src="../images/icon svg/active/menu-auto-token-icon.svg" width="20" height="20">
                            </div>
                            <span><font class="icon-menu-active">Auto Token</font></span>
                        </a>
                    </li>
                    <li class="menu-waves-block">
    ...
    <section class="content" id="content">
        <div class="container-fluid" id="maxDataItem">
            <div class="block-header title-name" >
                <div>Active Auto Token</div>
                    <br />
                    <img src="../images/icon svg/no.svg" class="iconno-noCard">
                <div class="pad20top" >
                    <h2 class="line-H">You don't have any active secret auth tokens.</h2>
                </div>
            </div>
        </div>
    </section>
