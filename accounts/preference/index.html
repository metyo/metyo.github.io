                ...
                <ul class="list">
                    ...
                    <li class="active-menu-right">
                        <a href="../preference" id="waves-effect-this">
                            <div class="icon-menu-img-left">
                                <img src="../images/icon svg/active/menu-preference-icon.svg" width="20" height="20">
                            </div>
                            <span><font class="icon-menu-active">Preference</font></span>
                        </a>
                    </li>
                    <li class="menu-waves-block">
    ...
    <section class="content" id="content">
        <div class="container-fluid" id="maxDataItem">
            <div class="block-header title-name" >
                <div>Preferences</div> 
                <div class="pad10top" >
                    <h2 class="line-H">Your preferences that help make GSky services more useful for you</h2>
                </div>
            </div>
            <div class="clearfix pad20top m-c1-top">
                <div>
                    <div class="card card20"  >
                        <div class="link-2-profile"  id="d-lk-top1" >  
                            <div class="w-in82">
                                <div class="text-grey4 link-content-home" > 
                                    <div class="line-H" >
                                        <div class="text-black-title">Manage User Preferences</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <a href="photo-view-permission" class="waves-effect waves-block" id="waves-block" > 
                            <div class="row link-3-profile" id="" >  
                                <div class="col-lg-3 col-md-3 col-sm-3">
                                    <div class="text-grey4 link-content-home" >Photo View Permission
                                    </div>
                                </div>
                                <div class="col-lg-7 col-md-7 col-sm-7">
                                    <div class="text-black1 link-content-home padding-bottom5 w-in82">----Empty Data----</div>
                                </div>
                        ...
                        <a href="date-format" class="waves-effect waves-block" id="waves-block" > 
                            <div class="row link-3-profile" id="" >  
                                <div class="col-lg-3 col-md-3 col-sm-3">
                                    <div class="text-grey4 link-content-home" >Date Format
                                    </div>
                                </div>
                                <div class="col-lg-7 col-md-7 col-sm-7">
                                    <div class="text-black1 link-content-home padding-bottom5 w-in82">dd-mm-yyyy</div>
                                </div>
                                <div class="col-lg-2 col-md-1 col-sm-2" id="item-link1">
                                    <div class="text-grey2 txt-ctr"> 
                                        <img src="../images/icon svg/next.svg" id="icon-right-link1">
                        ...
                        <a href="browser-connection" class="waves-effect waves-block" id="waves-block" > 
                            <div class="row link-3-profile" id="" >  
                                <div class="col-lg-3 col-md-3 col-sm-3">
                                    <div class="text-grey4 link-content-home" >Browser Connection
                                    </div>
                                </div>
                                <div class="col-lg-7 col-md-7 col-sm-7">
                                    <div class="text-black1 link-content-home padding-bottom5 w-in82">Always use Secure (https) Access</div>
                                </div>
                                <div class="col-lg-2 col-md-1 col-sm-2" id="item-link1">
                                    <div class="text-grey2 txt-ctr"> 
                                        <img src="../images/icon svg/next.svg" id="icon-right-link1">
                        ...
                        <a href="newsletter-subscription" class="waves-effect waves-block" id="waves-block" > 
                            <div class="row link-3-profile" id="" >  
                                <div class="col-lg-3 col-md-3 col-sm-3">
                                    <div class="text-grey4 link-content-home" >Newsletter Subscription
                                    </div>
                                </div>
                                <div class="col-lg-7 col-md-7 col-sm-7">
                                    <div class="text-black1 link-content-home padding-bottom5 w-in82">General Announcements</div>
                                </div>
                                <div class="col-lg-2 col-md-1 col-sm-2" id="item-link1">
                                    <div class="text-grey2 txt-ctr"> 
                                        <img src="../images/icon svg/next.svg" id="icon-right-link1">
                    ...
                    <div class="card card20"  >
                        <div class="link-2-profile" id="d-lk-top2"  >  
                            <div class="">
                                <div class="text-grey4 link-content-home" > 
                                    <div class="line-H" >
                                        <div class="text-black-title">Autorized </div>
                                        <div class="text-grey1 pad10top" >
                                            <div class="phone90">
                                                <font>You have granted the following websites to access your account:</font>
                                                ...
                                                <div class="body table-responsive">
                                                    <table class="table" width="100%">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <th scope="row">help.hiq.id</th>
                                                                <td>04/11/2015</td>
                                                                <td>110.137.186.96</td>
                                                                <td><a href="#">@Refoke Access</a></td>
                                                            </tr>
                                                            <tr>
                                                                <th scope="row">help.hiq.id</th>
                                                                <td>04/11/2015</td>
            ...
            <div class="m-c1-top clearfix pad20top">
                <div >
                    <div class="card card20" >
                        <div class="link-2-profile" id="d-lk-top3" >  
                            <div class="w-in82">
                                <div class="text-grey4 link-content-home" > 
                                    <div class="line-H" >
                                        <div class="text-black-title">Linked Account</div>
                                        <div class="text-grey1 pad10top">Kelola Linked Account.</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <a href="#" class="waves-effect waves-block" style=""> 
                            <div class="row link-2-profile" id="" >  
                                <div class="col-lg-3 col-md-3 col-sm-3">
                                    <div class="text-grey4 link-content-home" >Account
                                    </div>
                                </div>
                                <div class="col-lg-7 col-md-7 col-sm-7">
                                    <div class="text-black1 link-content-home padding-bottom5 w-in82">You don't have any Linked Accounts.</div>
                                </div>
                                <div class="col-lg-2 col-md-1 col-sm-2" id="item-link1">
                                </div>
                            </div>
            ...
            <div class="m-c1-top clearfix pad20top">
                <div>
                    <div class="card card20"  >
                        <div class="link-2-profile" id="d-lk-top4" >  
                            <div class="">
                                <div class="text-grey1 link-content-home" > 
                                    <div class="line-H" >
                                        <div class="text-black-title">SAML Authentication</div>
                                        <div class="phone90 pad10top">
                                            You are an administrator of your organization "hiQCare". To configure and use SAML authentication for your organization, you need to provide SAML URLs and the public key provided by the SAML/IDP service you have chosen.
                                        </div>
                                    </div>
                                </div>
                            </div>
