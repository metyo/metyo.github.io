...
<body class="bd-w">
                                    ...
                                    <ul class="ul-left-user">
                                        ...
                                        <li class="li-left-user padding-top10 padding-left5" ><font class="text-bold">Mohamad Eko Prasetyo</font><br />
                                            ...
                                            <div class="li-left-user-btn"> 
                                                <a href="../../my-accounts" id="a-border-trans-in-select"> 
    ...
    <section class="content-edit">
        ...
        <div class="container" id="card-link-profile">
            <div class="block-header title-name2" >
                <a href="../" id="back-link-profile">
                    ...
                    <span>Photo View Permission</span>
                </a> 
                <div class="pad10top">
        ...
        <div class="container" id="input-text-edit">
            <div class="rounded-lg" id="card-phone2">
                <div class="">
                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10">
                        <div class="input-text-edit"> Select Photo View Permission</div>
                    </div>
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                        <a href="" data-toggle="modal" data-target="#add-data-permission" id="icon-edit-data">
                            <div class="f-right">
    ...
    <div id="add-data-permission" class="modal fade" >
        <div class="modal-dialog modal-sm">
            <div class="modal-content w100" >
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-t20">Photo View Permission</h4>
                </div>
                <div class="modal-body" id="modal-body-pad"  >
                    <form method="post" id="create-data" >
                        <select class="form-control1 t16" id="permission">
                            <option value="">Select Permission</option>
                            <option value="Foto2">Contoh 1</option>
                            <option value="Foto1">Contoh 2</option>
                        </select>
                        <div class="pad30top"></div>
                        <div class="modal-edit" >
                            <div class="button-edit">
                                <button class="button-text-grey" type="button" id="btn-batal-create"  data-dismiss="modal"> Close </button> 
                                <button class="button-text-blue" type="button" id="btn-create-data-permission"  > Done </button>
                            </div>
                        </div>
                    </form>
                </div>
...
<script type="text/javascript">
    $('#btn-create-data-permission').click(function(){
        var permission = $('#permission');
        var classpermission = $('#classpermission');
        if( permission.val() == '' || permission.val() == null)
        {
            alert('Please select Photo View Permission !');
            return false;
        }
        else{
            $('#add-data-permission').modal('hide');
            permission.val('');
            classpermission.removeClass('focused');
