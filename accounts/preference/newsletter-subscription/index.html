...
<body class="bd-w">
    ...
    <section class="content-edit">
        ...
        <div class="container" id="input-text-edit">
            <div class="rounded-lg" id="card-phone2">
                <div class="">
                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10">
                        <div class="input-text-edit"> General Announcements</div>
                    </div>
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                        <a href="" data-toggle="modal" data-target="#add-data-newsletter" id="icon-edit-data">
                            <div class="f-right">
    ...
    <div id="add-data-newsletter" class="modal fade" >
        <div class="modal-dialog modal-sm">
            <div class="modal-content w100">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-t20">Newsletter Subscription</h4>
                </div>
                <div class="modal-body" id="modal-body-pad" >
                    <form method="post" id="create-data" >
                        <div>
                            ...
                            <label for="basic_checkbox_2" class="chk-brows edit-style">General Announcements</label>
                        </div>
                        <div>
                            <input type="checkbox" id="basic_checkbox_3" class="filled-in" >
                            <label for="basic_checkbox_3" class="chk-brows edit-style">Product Announcements</label>
                        </div>
                        <div>
                            <input type="checkbox" id="basic_checkbox_4" class="filled-in" >
                            <label for="basic_checkbox_4" class="chk-brows edit-style">Updates to Products</label>
                        </div>

                        <div class="pad20top"></div>
                        <div class="modal-edit" >
                            <div class="button-edit">
                            <button class="button-text-grey" type="button" id="btn-create-data"  data-dismiss="modal"> Close </button> 
                            <button class="button-text-blue" type="button" id="btn-create-data-newsletter"  > Done </button>
                            </div>
                        </div>
                    </form>
                </div>
...
<script type="text/javascript">
    $('#btn-create-data-newsletter').click(function(){
        
            $('#add-data-newsletter').modal('hide');
