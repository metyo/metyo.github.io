...
<body class="bd-w">
        ...
        <div class="container" id="input-text-edit">
            <div class="rounded-lg" id="card-phone2">
                <div class="">
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                        <a href="" data-toggle="modal" data-target="#add-data-date_format" id="icon-edit-data">
                            <div class="f-right">
    ...
    <div id="add-data-date_format" class="modal fade" >
        <div class="modal-dialog modal-sm">
            <div class="modal-content w100" >
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-t20">Date Format</h4>
                </div>
                <div class="modal-body" id="modal-body-pad"  >
                    <form method="post" id="create-data" >
                        <div class="form-group form-float">
                            <div class="form-line">
                                <input type="date" class="form-control t16" id="date_format" />
                            </div>
                        </div>
                        ...
                        <div class="modal-edit" >
                            <div class="button-edit">
                                ...
                                <button class="button-text-blue" type="button" id="btn-create-data-date_format"  > Done </button>
                            </div>
                        </div>
                    </form>
                </div>
...
<script type="text/javascript">
    $('#btn-create-data-date_format').click(function(){
        ...
        if( date_format.val() == '' || date_format.val() == null)
        {
            ...
            $('#add-data-date_format').modal('hide');
