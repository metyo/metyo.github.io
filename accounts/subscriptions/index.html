                ...
                <ul class="list">
                    ...
                    <li class="active-menu-right">
                        <a href="../subscriptions" id="waves-effect-this">
                            <div class="icon-menu-img-left">
                                <img src="../images/icon svg/active/menu-subscriptions-icon.svg" width="20" height="20">
                            </div>
                            <span><font class="icon-menu-active">Subscriptions</font></span>
                        </a>
                    </li>
                    <li class="menu-waves-block">
                        ...
                        <div class="link-2-profile" id="d-lk-top3" >  
                            <div class="w-in82">
                                <div class="text-grey4 link-content-home" > 
                                    <div class="line-H" >
                                        <div class="text-black-title">My Subscriptions</div>
                                        <div class="text-grey1 pad10top">All Subscriptions.</div>
                                        <div class="pad10top">
                                            <a href=""><button class="btn btn-success padtop5" >Add Services</button></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <a href="#" class="waves-effect waves-block" style=""> 
                            <div class="row link-2-profile" id="" >  
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-7">
                                    <div class="text-black1 link-content-home padding-bottom5 w-in82">You have no subscriptions in this Account.</div>
                                </div>
                        ...
                        <div class="link-2-profile" id="d-lk-top4" >  
                            <div class="">
                                <div class="text-grey1 link-content-home" > 
                                    <div class="line-H" >
                                        <div class="text-black-title">Payment Methods</div>
                                        <div class="text-grey1 pad10top">All Payment Methods.</div>
                                        <div class="phone90 pad10top text-null">
                                            <br />
                                            <img src="../images/icon svg/no.svg" class="iconno">
                                            <br />
                                            <br />
                                            You don't have payment methods at now.
                                        </div>
                                    </div>
                                </div>
                            </div>
